...
describe('URLWithParams function', () => {
  it('should properly generate a URL with given pathname and parameters', () => {
    ...
    const expectedURL = `${KEYDROP_URLS.main}testPath?testParam=testValue&testArrayParam=1&testArrayParam=2&testArrayParam=3&testBooleanParam=true`
  ...
  it('should not append parameters with undefined values', () => {
    ...
    const expectedURL = `${KEYDROP_URLS.main}testPath`
